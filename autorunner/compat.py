...
from autorunner.loader import load_project_meta, convert_relative_project_root_dir
from autorunner.parser import parse_data
from autorunner.utils import sort_dict_by_custom_order
...
def _generate_conftest_for_summary(args: List):
    ...
    conftest_content = '''# NOTICE: Generated By autorunner.
import json
import os
import time
...
from autorunner.utils import get_platform, ExtendJSONEncoder
